        ...
        stage('Checkout Base Image Git Repository') {
            steps {
                git branch: 'master',
                     ...
                     url: '${GERRIT_MIRROR}/OSS/ENM-Parent/SQ-Gate/com.ericsson.oss.containerisation/ruleset_baseimage02'
                sh '''
                    git remote set-url origin --push https://${GERRIT_HTTP_CREDENTIALS_FUser}@${GERRIT_CENTRAL_HTTP_E2E}/OSS/ENM-Parent/SQ-Gate/com.ericsson.oss.containerisation/ruleset_baseimage02
                '''
            }
        }
